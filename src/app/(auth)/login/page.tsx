    ...
    <div className="flex h-screen w-full items-center justify-center bg-gray-50">
      <div className="w-full max-w-md space-y-8 rounded-xl bg-white p-6 sm:p-10 shadow-md mx-4 sm:mx-0">
        <div className="text-center">
          <h2 className="text-2xl sm:text-3xl font-bold tracking-tight text-gray-900">{t('signIn')}</h2>
          <p className="mt-2 text-sm text-gray-600">
            Or <Link href="/register" className="font-medium text-blue-600 hover:text-blue-500">{t('signUp')}</Link>
          </p>
        </div>
