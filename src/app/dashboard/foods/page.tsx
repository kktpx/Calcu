  ...
  return (
    <div className="max-w-lg mx-auto p-4 sm:p-6 space-y-6">
      <header className="flex flex-col items-start bg-white dark:bg-zinc-900 rounded-2xl p-6 shadow-sm border border-zinc-100 dark:border-zinc-800">
        <h1 className="text-xl font-bold tracking-tight">Food Database</h1>
        <p className="text-zinc-500 dark:text-zinc-400 text-sm mt-1">
          Manage your custom foods and let AI analyze nutrition from photos.
        </p>
      </header>
      ...
      <div className="bg-white dark:bg-zinc-900 rounded-2xl shadow-sm border border-zinc-100 dark:border-zinc-800 overflow-hidden">
        <div className="p-6 border-b border-zinc-100 dark:border-zinc-800">
          <h2 className="text-xl font-bold">Your Foods</h2>
        </div>
